            ...
            {contactMethods.map((method) => {
              ...
              return (
                <motion.a
                  ...
                  href={method.href}
                  variants={listItem}
                  className="bg-card rounded-lg p-6 hover:border-accent/50 transition-smooth group cursor-pointer"
                  whileHover={{ x: 4 }}
                >
            ...
            <motion.div variants={listItem} className="pt-6 border-t border-border">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="bg-card p-3 rounded-lg hover:border-accent/50 transition-smooth hover:bg-accent/10"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-card p-3 rounded-lg border border-accent/20 hover:border-accent/50 transition-smooth hover:bg-accent/10"
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
